...
module KubesAws::Dsl::IamRole
  class Registry
    class_attribute :iam_statements
    self.iam_statements = nil # nil to allow fallback to default_iam_statements in kubes/role.rb
    class_attribute :managed_policy_arns
    self.managed_policy_arns = nil # nil to allow fallback to default_managed_policy_arns in kubes/role.rb
